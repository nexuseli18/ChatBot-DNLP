...
#Dictionary to map lines to id 6
id2line = {} 
for line in lines :
    _line = line.split(" +++$+++ ")
    if len(_line)==5:
...
with open('questions.txt', 'w+') as f:
    ...
    for items in sorted_clean_questions:
        f.write('%s\n' %items)
...
with open('answers.txt', 'w+') as f:
    ...
    # write elements of list
    for items in sorted_clean_answers:
        f.write('%s\n' %items)
...
# S2s Model
def seq2seq_model(inputs, targets, keep_prob, batch_size, sequence_length, answers_num_words, questions_num_words,encoder_embedding_size, decoder_embedding_size,enn_size,num_layers, questionswords2int):
...
#getting training and testing preds
...
#Setting up loss error , optimisation and gradient clipping
...
checkpoint = r'.\chatbot_weights.ckpt'
